<?php
    $sqlArrayFunction   = array ( 
                            'select' 		=>	'functions_id, functions_title, functions_file, functions_photo, functions_desc, id_type, date_added'
                            ,'where' 		=>	array( 
                                                          'functions_status'	=> '1'
                                                        , 'is_deleted'	        => '0'
                                                        , 'functions_href'	    => cleanvars($_GET['href'])
                                                    )
                            ,'return_type' 	=> 'single' 
                        ); 
    $rowsFunction  = $dblms->getRows(FUNCTIONS, $sqlArrayFunction);
        ...
        <div class="container">
            <div class="portfolio-block">
                <div class="portfolio-details-video">
                    <img src="'.SITE_URL.'uploads/images/functions/'.$rowsFunction['functions_photo'].'">
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="portfolio-block">
                        <div class="protfolio-details-two">
                            <h3>'.$rowsFunction['functions_title'].'</h3>
