            ...
            <nav>
                <ul class="pagination justify-content-end mb-0 mt-3">';
                    ...
                    if($lastpage >= 1){
                        // PREVIOUS BUTTON
                        if($page > 0){
                            $pagination.= '<li class="page-item '.($page==1 ? 'disabled' : '').'"><a class="page-link" href="'.$current_page.'.php?'.$filters.'&page='.$prev.$sqlstring.'"><i class="mdi mdi-chevron-left"></i></a></li>';
                        }
                        ...
                        // NEXT BUTTON
                        if($page < $counter){
                            $pagination.= '<li class="page-item '.($page==$counter-1 ? 'disabled' : '').'"><a class="page-link" href="'.$current_page.'.php?'.$filters.'&page='.$next.$sqlstring.'"><i class="mdi mdi-chevron-right"></i></a></li>';
                        }else{
                            $pagination.= "";
                        }
                        echo $pagination;
