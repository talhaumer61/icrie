...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="bookmark">
            <a class="btn btn-primary btn-sm" href="publications.php?view=add"><i class="fas fa-plus-circle me-1"></i>'.moduleName(false).'</a>
        </div>
    </div>
</div>
<div class="row">
                        ...
                        <tbody>';
                            ...
                            if ($publications) {
                                foreach ($publications as $row) { 
                                    ...
                                    $file_url = SITE_URL.'uploads/images/publications/'.$row['publication_photo'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="fw-bold">'.$row['publication_title'].'</div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-danger btn-xs" onclick="confirm_modal(\''.moduleName().'.php?deleteid='.$row['publication_id'].'\');"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>';
                                }
                            }
