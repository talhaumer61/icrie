        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col mb-2">
                    ...
                    <input type="text" class="form-control" name="team_designation" required />
                </div>
                <div class="col mb-2">
                    <label class="form-label">Degree <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="team_degree" required />
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                ...
                <div class="col mb-2">
                    ...
                    <input type="number" class="form-control" name="id_priority" required />
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Facebook <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="team_fb" required />
                </div>
                <div class="col mb-2">
                    <label class="form-label">Twitter <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="team_twitter" required />
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Linkedin <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="team_linkedin" required />
                </div>
                <div class="col mb-2">
                    <label class="form-label">Instagram <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="team_insta" required />
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Detail</label>
                    <textarea class="form-control" id="ckeditor1" name="team_desc"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
