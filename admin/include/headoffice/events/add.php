        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col mb-2">
                    ...
                    <input class="form-control digits" type="date" name="event_date">
                </div>
                <div class="col mb-2">
                    <label class="form-label">Time <span class="text-danger">*</span></label>
                    <input class="form-control digits" type="time" name="event_time">
                </div>
                <div class="col mb-2">
            ...
            <div class="row">
                ...
                <div class="col mb-2">
                    ...
                    <input type="text" class="form-control" name="event_reg_link" required />
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Description</label>
                    <textarea class="form-control" name="event_brief_detail"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Detail</label>
                    <textarea class="form-control" id="ckeditor1" name="event_detail"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
