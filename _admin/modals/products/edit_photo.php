...
$row = $dblms->getRows(PRODUCTS_PHOTOS, $condition);

$fileInfo = pathinfo($row['pp_photo']);
    ...
    <div class="modal-content">
        <form method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary btn-sm" type="submit" name="submit_edit_photo">Save</button>
