...
$sqllms = $dblms->querylms("SELECT * FROM ".GALLERY." WHERE gallery_id =  ".cleanvars($_GET['id'])." ");
...
<div class="col-lg-12">
   <div class="card">
      <div class="card-body">
         <h4 class="card-title mb-4">Edit Gallery Photo</h4>
         ...
         <form action="gallery.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="file" id="gallery_photo" name="gallery_photo" class="form-control" >
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <select name="gallery_status" id="gallery_status" class="form-control select2" required>
                        ...
                        if($value_gallery['gallery_status'] == $adm_status['status_id']){
                        echo '
            ...
            <div class="mt-4 float-right" >
               ...
               <button type="submit" name="edit_gallery" class="btn btn-primary w-md">Save Changes</button>
            </div>
         </form>
      </div>
   </div>
