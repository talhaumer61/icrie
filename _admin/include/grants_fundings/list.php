...
if(!LMS_VIEW && !isset($_GET['id'])) {  
   ...
   $sqllms  = $dblms->querylms("SELECT grant_id
                                       FROM ".GRANTS." 
                                       WHERE grant_id != '' AND grant_type = '2'
...
<div class="row">
   <div class="col-lg-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4 float-left"> <i class="mdi mdi-cash-usd"></i> Grants & Fundings List</h4>
            <div class="card-title mb-4 float-right"> 
               <a href="grants_fundings.php" class="btn btn-primary"><i class="fa fa-list"></i> All </a>
                     ...
                     while($value_grant = mysqli_fetch_array($sqllms)) {
                        ...
                        <tr>
                           ...
                           <td class="text-center">
                              <img src="../images/grants/nonrecurring_grants/'.$value_grant['grant_photo'].'" alt="'.$value_grant['grant_title'].'" class="rounded-circle avatar-sm">
                           </td>
