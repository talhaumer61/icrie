<?php
   ...
   if(!LMS_VIEW && !isset($_GET['id'])) {  
      ...
      $sqllms  = $dblms->querylms("SELECT blog_id, blog_status, blog_title, blog_date, blog_photo, blog_detail
                                    FROM ".BLOGS." 
      ...
      $sqllms  = $dblms->querylms("SELECT blog_id, blog_status, blog_title, blog_date, blog_photo, blog_detail
                                    ...
                                    WHERE blog_id != '' AND is_deleted = '0'
                                    $sql2
                                    ORDER BY blog_id DESC LIMIT ".($page-1)*$Limit .",$Limit
                                 ");
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                  <h4 class="card-title mb-4 float-left"> <i class="fa fa-newspaper"></i> Blogs List</h4>
                           ...
                           while($value_blog = mysqli_fetch_array($sqllms)) {
                              ...
                              <tr>
                                 ...
                                 <td  class="text-center">
                                    <img src="../images/news_events/'.$value_blog['blog_photo'].'" alt="'.$value_blog['blog_date'].'" class="rounded-circle avatar-sm">
                                 </td>
                                 <td>'.$value_blog['blog_date'].'</td>
                                 <td>'.$value_blog['blog_title'].'</td>
                                 <td class="text-center">'.get_admstatus($value_blog['blog_status']).'</td>
                                 <td class="text-center">
                                    <a href="?id='.$value_blog['blog_id'].'" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                    ...
                                    <div class="modal-content">
                                       <form method="POST" action="blogs.php">
                                          ...
                                          <div class="modal-body">
                                             <input type="hidden" name="blog_id" value="'.$value_blog['blog_id'].'">
                                             <p>Are you sure you want to delete Blog:</p>
                                             <h5>'.$value_blog['blog_title'].'</h5>
                                          </div>
