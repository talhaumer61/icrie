<?php
   ...
   <div class="row">
      <div class="col-lg-12">
         <div class="card">
            <div class="card-body">
               <h4 class="card-title mb-4 float-left"> <i class="fa fa-users"></i> Function List</h4>
                     ...
                     <tbody>';
                        ...
                        foreach($rows as $key => $val):
                           ...
                           <tr>
                              ...
                              <td class="line-clamp-1">'.$val['functions_desc'].'</td>
                                    ...
                                    <div class="modal-content">
                                       <form method="POST" action="functions.php">
                                          ...
                                          <div class="modal-footer">
                                             ...
                                             <button type="submit" name="functions_delete" class="btn btn-danger">Delete</button>
                                          </div>
                                       </form>
                                    </div>
                                 </div>
