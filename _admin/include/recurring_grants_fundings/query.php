<?php
if(isset($_POST['submit_recurr_grant'])) { 
    ...
    if($sqllms) { 
        ...
        if(!empty($_FILES['grant_photo']['name'])) {
            //--------------------------------------
                ...
                $img_dir 	= '../images/grants/recurring_grants/';
            //--------------------------------------
        ...
        header("Location: recurring_grants_fundings.php", true, 301);
		exit();
...
if(isset($_POST['edit_recurr_grant'])) { 
    //------------------------------------------------
    $open_date = date("Y-m-d", strtotime($_POST['open_date']));
    //------------------------------------------------
