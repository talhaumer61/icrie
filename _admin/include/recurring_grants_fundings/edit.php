...
//------------------------------------------------
$Fields = array(
   "grant_title"  	       =>  array(  "title" => "Title"     ,    "type" => "text"  ,     "class" => "col-md-12"   ) ,
   "open_date"       	    =>  array(  "title" => "Open Date" ,    "type" => "date"  ,     "class" => "col-md-4"    ) ,             
   "close_date"       	    =>  array(  "title" => "Dead Line" ,    "type" => "text"  ,     "class" => "col-md-4"    ) ,             
   "grant_apply_link"  	    =>  array(  "title" => "Apply Link",    "type" => "text"  ,     "class" => "col-md-4"    )                
);
//------------------------------------------------
...
<div class="col-lg-12">
   <div class="card">
      <div class="card-body">
         ...
         <form action="recurring_grants_fundings.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">';
               ...
               <div class="'.$value['class'].'">
                  <div class="form-group">
                     ...
                     <input type="'.$value['type'].'" class="form-control" name="'.$key.'" value="'.$value_grant[$key].'" id="'.$key.'" required>
                  </div>
               </div>';
               }
               echo'                          
            ...
            <div class="mt-4 float-right" >
               <a href="recurring_grants_fundings.php" class="btn btn-dark w-md">Cancel</a>
               <button type="submit" name="edit_recurr_grant" class="btn btn-primary w-md">Save Changes</button>
            </div>
         </form>
      </div>
   </div>
