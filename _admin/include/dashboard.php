...
$countContacts = $dblms->getRows(CONTACT, $condition);
...
$CONTACT = $dblms->getRows(CONTACT, $condition);
        ...
        <div class="row">
            <div class="col">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">'.moduleName(ZONE).'</li>
                                        ...
                                        foreach ($CONTACT as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-secondary btn-xs" onclick="showAjaxModalZoom(\''.SITE_URL.'admin/modals/contact/view.php?view=query_detail&edit_id='.$row['contact_id'].'\');"><i class="fa-solid fa-eye"></i></a>
                                                </td>
                                            </tr>';
                                        } 
                                    }
